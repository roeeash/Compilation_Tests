    ...
    public static void main(String[] var0) {
	    ...
	    test_generic("../../", "./input/test2/Makefile.txt","/ex3/Makefile");
            ...
            for(int var4 = lbound; var4 <= rbound; ++var4) {
                try {
                    test_generic("../../", "./input/test2/test (" + var4 + ").txt","/ex3/input/Input.txt");
                ...
                try {
                    Path var5 = Paths.get("../../Compilation_Tests/test_folder_proj3/output/output2/output (" + var4 + ").txt");
                    Path var6 = Paths.get("../../ex3/output/SemanticStatus.txt");
                    FileReader var11 = new FileReader("../../ex3/output/SemanticStatus.txt");
                    FileReader var12 = new FileReader("../../Compilation_Tests/test_folder_proj3/output/output2/output (" + var4 + ").txt");
